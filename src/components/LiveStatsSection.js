  ...
  return (
    <section className="py-16 px-4 md:px-8 lg:px-16">
      <div className="max-w-7xl mx-auto">
        <div className="p-[1px] bg-gradient-to-r from-sky-400 to-blue-500 rounded-xl">
          <div className="bg-[#0A0F17] rounded-xl p-6 md:p-8">
            <div className="flex flex-col md:flex-row justify-between">
              {/* Stats Cards */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
                <div className="bg-[#0B1324] rounded-lg p-5 flex items-center space-x-4 border border-sky-400/20">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center bg-gradient-to-r from-sky-400/30 to-blue-500/30">
            ...
            <div className="mt-8">
              <h3 className="text-white font-medium mb-4 flex items-center">
                <div className="w-1 h-4 bg-gradient-to-r from-sky-400 to-blue-500 rounded-full mr-2"></div>
                Recent Big Winners
              </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {stats.recentWinners.map(winner => (
                  <div 
                    key={winner.id} 
                    className="p-[1px] bg-gradient-to-r from-sky-400/40 to-blue-500/40 rounded-lg"
                  >
                    <div className="bg-[#0B1324] rounded-lg p-4 border border-sky-400/10">
